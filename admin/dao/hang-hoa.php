...
function hang_hoa_insert($ten_hh, $hinh, $hinh1, $hinh2, $hinh3, $don_gia, $giam_gia, $mo_ta, $ma_loai)
{ //hàm thêm hàng hóa
    $sql = "INSERT INTO hang_hoa(ten_hh,hinh,hinh1,hinh2,hinh3,don_gia,giam_gia,mo_ta,ma_loai) VALUES (?,?,?,?,?,?,?,?,?)"; //chèn vào bảng hh các thông tin tương ứng
    pdo_execute($sql, $ten_hh, $hinh, $hinh1, $hinh2, $hinh3, $don_gia, $giam_gia, $mo_ta, $ma_loai);
}

function hang_hoa_update($ma_hh, $ten_hh, $don_gia, $giam_gia, $hinh, $hinh1, $hinh2, $hinh3, $ma_loai, $mo_ta)
{ //sửa sản phẩm
    $sql = "UPDATE hang_hoa SET ten_hh=?, don_gia=?, giam_gia=?, hinh=?, hinh1=?, hinh2=?, hinh3=?, ma_loai=?, mo_ta=? WHERE ma_hh=?"; //cập nhật tt sp theo mã sp
    pdo_execute($sql, $ten_hh, $don_gia, $giam_gia, $hinh, $hinh1, $hinh2, $hinh3, $ma_loai, $mo_ta, $ma_hh);
}
